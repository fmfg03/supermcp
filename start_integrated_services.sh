...
echo "📊 Dashboard:             http://localhost:8126"
echo "✅ Validation:            http://localhost:8127"
echo "👀 Monitoring:            http://localhost:8125"
echo "🌉 Enterprise Bridge:      http://localhost:8128"
echo ""
echo "🤖 A2A COMMUNICATION:"
echo "📡 A2A Server:            http://localhost:8200"
